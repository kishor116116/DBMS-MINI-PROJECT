...
const data = {
  Gowribidnur: [
    ...
    {
      name: "Modern Living Gowribidnur",
      rent: 13000,
      floor: "First Floor",
      type: "2BHK",
      images: [
    ...
    {
      name: "Gowribidnur Central Apartments",
      rent: 9000,
      floor: "Ground Floor",
      type: "1BHK",
      images: [
  ...
  NandiHills: [
    ...
    {
      name: "NandiHills Luxe Apartments",
      rent: 14000,
      floor: "First Floor",
      type: "2BHK",
      images: [
  ...
  peresandra: [
    ...
    {
      name: "peresandra Green Apartments",
      rent: 9000,
      floor: "Ground Floor",
      type: "1BHK",
      images: [
    ...
    {
      name: "peresandra Park Residency",
      rent: 13000,
      floor: "First Floor",
      type: "2BHK",
      images: [
    ...
    {
      name: "peresandra Serenity Homes",
      rent: 8500,
      floor: "Ground Floor",
      type: "1BHK",
      images: [
  ...
  devanahalli: [
    ...
    {
      name: "devanahalli Green Residency",
      rent: 9000,
      floor: "Ground Floor",
      type: "1BHK",
      images: [
...
export default function BangaloreStay() {
  const [selectedArea, setSelectedArea] = useState("Gowribidnur");

...
const data = {
  ...
  kodialbail: [
    ...
    {
      name: "kodialbail Luxe Apartments",
      rent: 14000,
      floor: "First Floor",
      type: "2BHK",
      images: [
  ...
  Kankanady: [
    ...
    {
      name: "Kankanady Green Apartments",
      rent: 9000,
      floor: "Ground Floor",
      type: "1BHK",
      images: [
  ...
  Pandeshwar: [
    ...
    {
      name: "Pandeshwar Green Residency",
      rent: 9000,
      floor: "Ground Floor",
      type: "1BHK",
      images: [

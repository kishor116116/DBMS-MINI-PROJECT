...
const data = {
  hassancity: [
    ...
    {
      name: "Modern Living hassan City",
      rent: 13000,
      floor: "First Floor",
      type: "2BHK",
       images: [
    ...
    {
      name: "hassan City Central Apartments",
      rent: 9000,
      floor: "Ground Floor",
      type: "1BHK",
      images: [
  ...
  sakleshpur: [
    ...
    {
      name: "sakleshpur Green Apartments",
      rent: 9000,
      floor: "Ground Floor",
      type: "1BHK",
      images: [
    ...
    {
      name: "sakleshpur Park Residency",
      rent: 13000,
      floor: "First Floor",
      type: "2BHK",
      images: [
    ...
    {
      name: "sakleshpur Serenity Homes",
      rent: 8500,
      floor: "Ground Floor",
      type: "1BHK",
      images: [
...
export default function BangaloreStay() {
  const [selectedArea, setSelectedArea] = useState("hassan City");
